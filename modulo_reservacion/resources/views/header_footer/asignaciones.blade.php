...
<html lang="es">
    ...
    <body class= "">
        ...
        <section class= "h-80 md:h-96 flex items-center bg-center bg-cover bg-blend-overlay bg-black/40 text-white" style="background-image: url('https://elcierzo.com/wp-content/uploads/2020/08/salon-restaurante-el-cierzo-0010-1024x514.jpg')">
            <section class= "text-center mx-auto">
                <h2 class= "text-4xl md:text-5xl font-mont">Asignación en el</h2>
